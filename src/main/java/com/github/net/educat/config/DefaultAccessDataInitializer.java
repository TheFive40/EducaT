...
public class DefaultAccessDataInitializer implements ApplicationRunner {
    ...
    private static final List<String> ADMIN_DEFAULT_PERMISSIONS = List.of(
            ...
            "bienestar.crear-publicacion.psicologia",
            "bienestar.crear-publicacion.deportes",
            "bienestar.crear-publicacion.arte",
            "bienestar.crear-publicacion.orientacion",
            "bienestar.crear-publicacion.salud",
            "bienestar.crear-publicacion.becas",
            ...
            "evaluacion.ver-reporte-docente",
            "evaluacion.ver-reporte-admin",
            P_ADMIN,
            P_TEACHER,
            P_STUDENT
    );
